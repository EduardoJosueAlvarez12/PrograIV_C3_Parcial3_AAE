  ...
  <b-jumbotron id="login-jumbotron" class="jumbotron jumbotron-fluid">
    ...
    <b-container class="flex-container-space-between">
        ...
        <div id="arrow-button" type="button">
            <b-button to="/aae/feed" style="background-color: #4F14A0; border-color: #4F14A0">
        ...
        <div>
            ...
            <div id="login-title">
                <h1 style="font-size: 70px; color: #FFFFFF">Iniciar <br />
                    Sesión</h1>
                <p style="font-size: 15px; color: #BEA6ED">¿No tiene una cuenta? <router-link to="">Regístrese</router-link></p>
            </div>
        </div>
            ...
            <div id="login-form" class="container-fluid">
                <form v-on:submit.prevent="login">
                    ...
                    <div id="login-control">
                        <input id="correo" type="" class="form-control-fluid form-control"  name="email" placeholder="Correo" v-model="correo">
                    </div>

                    <div id="login-control">
                        <input id="contrasenia" type="password"  class="form-control-fluid form-control" name="contrasenia" placeholder="Contrasenia" v-model="contrasenia">
                    </div>
...
export default {
  ...
  methods: {
    login() {
      ...
      axios.post("http://localhost:3001/api/user/login", json).then((data) => {
